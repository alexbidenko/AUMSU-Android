...
class GalleryFragment : Fragment() {
    ...
    private fun getPhotos(view: View) {
        ...
        val pagerAdapter = GalleryFragmentPagerAdapter(activity!!.supportFragmentManager, photos)
    ...
    private fun openPhoto(position: Int) {
        view!!.opened_gallery.currentItem = position
        view!!.gallery_layout.visibility = View.VISIBLE
    }
